 ...
 ?>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.php" class="logo me-auto"><img src="assets/img/logo.png" alt=""><img src="assets/images/sohochorilogo.jpg" alt="Sohochori Logo" style="height: 40px; vertical-align: middle;"><span style="font-weight: bold; margin-left: 10px;">SOHOCHORI</span></a>
